                ...
                <div className="relative z-10 w-full max-w-6xl mx-4 flex">
                    ...
                    <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
                        <div className="w-full max-w-md bg-gray-800/40 backdrop-blur-xl rounded-3xl p-8 border border-gray-600/30">
                            {/* OAuth Buttons for Mobile - Top */}
                            <div className="lg:hidden space-y-3 mb-6">
                                <div className="text-center text-gray-400 text-sm mb-4">Continue with</div>
                                
                                <button 
                                    onClick={() => window.location.href = `${BASE_URL}/auth/google`}
                                    className="flex items-center justify-center gap-3 bg-white/10 backdrop-blur-sm border border-gray-600/50 rounded-full px-6 py-3 text-gray-300 hover:bg-white/20 transition-all duration-300 w-full group"
                                >
                                    ...
                                    <span className="group-hover:text-white transition-colors text-sm">Google</span>
                                </button>
                                
                                <button 
                                    onClick={() => window.location.href = `${BASE_URL}/auth/github`}
                                    className="flex items-center justify-center gap-3 bg-gray-900/50 backdrop-blur-sm border border-gray-600/50 rounded-full px-6 py-3 text-gray-300 hover:bg-gray-800/70 transition-all duration-300 w-full group"
                                >
                                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                                        <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                                    </svg>
                                    <span className="group-hover:text-white transition-colors text-sm">GitHub</span>
                                </button>
                            ...
                            <div className="space-y-6">
                                ...
                                {/* Mobile Toggle */}
                                <div className="md:hidden text-center text-gray-500 text-sm mt-6">
                                    {isLoginForm ? 'Not yet a member?' : 'Already have an account?'}{' '}
                                    <button 
                                        onClick={() => setIsLoginForm(!isLoginForm)}
                                        className="text-gray-300 hover:text-white underline underline-offset-4 font-medium"
